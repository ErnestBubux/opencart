...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 02 2021 г., 23:35
...
(1, 'Default', '', 1, '2021-02-02 22:14:39', '2021-02-02 22:14:39');
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2021-02-02 20:22:30'),
...
(34, 'change_product_title', 'catalog/view/product/product/before', 'extension/module/demoevent/change', 1, 0),
(35, 'add_new_item_menu', 'admin/view/common/column_left/before', 'extension/module/menu_add/add', 1, 0);
...
(1, 0, 'cod3x.ocmod.zip', '2021-02-02 22:20:39');
...
(1, 1, 'MultiStore Cash On Delivery', 'multistore_cash_on_delivery', 'Extensions Bazaar', '1.0', 'http://www.extensionsbazaar.com', '<modification>\r\n	<name>MultiStore Cash On Delivery</name>\r\n	<code>multistore_cash_on_delivery</code>\r\n	<version>1.0</version>\r\n	<author>Extensions Bazaar</author>\r\n	<link>http://www.extensionsbazaar.com</link>\r\n	\r\n	<file path=\"admin/view/template/extension/payment/cod.twig\">\r\n		<operation>\r\n			<search><![CDATA[<h3 class=\"panel-title\"><i class=\"fa fa-pencil\"></i> {{ text_edit }}</h3>]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				<div class=\"pull-right\">\r\n					<b>Stores : </b><select onchange=\"location = this.options[this.selectedIndex].value;\">\r\n					<option value=\"{{store_action}}&store_id=0\">{{ text_default }}</option>\r\n						{% for store in stores %}\r\n							{% if store.store_id==store_id %}\r\n							<option selected=\"selected\" value=\"{{store_action}}&store_id={{store.store_id}}\">{{store.name}}</option>\r\n							{% else %}\r\n							<option value=\"{{store_action}}&store_id={{store.store_id}}\">{{store.name}}</option>\r\n							{% endif %}\r\n						{% endfor %}\r\n					</select>\r\n				</div>\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n	<file path=\"admin/controller/extension/payment/cod.php\">\r\n		<operation>\r\n			<search><![CDATA[$data[\'action\'] = $this->url->link(\'extension/payment/cod\', \'user_token=\' . $this->session->data[\'user_token\']]]></search>\r\n			<add position=\"replace\"><![CDATA[$data[\'action\'] = $this->url->link(\'extension/payment/cod\', \'user_token=\' . $this->session->data[\'user_token\'] . \'&store_id=\'. $data[\'store_id\']]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$this->load->model(\'setting/setting\');]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				if(isset($this->request->get[\'store_id\'])) {\r\n					$data[\'store_id\'] = $this->request->get[\'store_id\'];\r\n				}else{\r\n					$data[\'store_id\']	= 0;\r\n				}\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$this->model_setting_setting->editSetting(\'payment_cod\', $this->request->post);]]></search>\r\n			<add position=\"replace\"><![CDATA[$this->model_setting_setting->editSetting(\'payment_cod\', $this->request->post,$data[\'store_id\']);]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'cancel\'] = $this->url->link(\'marketplace/extension\']]></search>\r\n			<add position=\"before\"><![CDATA[\r\n				$data[\'store_action\'] =  $this->url->link(\'extension/payment/cod\',\'user_token=\' . $this->session->data[\'user_token\'], true);\r\n				$this->load->model(\'setting/store\');\r\n				$data[\'stores\'] = $this->model_setting_store->getStores();\r\n				$data[\'text_default\'] = $this->language->get(\'text_default\');\r\n				$store_info = $this->model_setting_setting->getSetting(\'payment_cod\', $data[\'store_id\']);\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'payment_cod_total\'] = $this->request->post[\'payment_cod_total\'];]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				}elseif(isset($store_info[\'payment_cod_total\'])){\r\n				 $data[\'payment_cod_total\'] = $store_info[\'payment_cod_total\'];\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'payment_cod_order_status_id\'] = $this->request->post[\'payment_cod_order_status_id\'];]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				}elseif(isset($store_info[\'payment_cod_order_status_id\'])){\r\n				 $data[\'payment_cod_order_status_id\'] = $store_info[\'payment_cod_order_status_id\'];\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'payment_cod_geo_zone_id\'] = $this->request->post[\'payment_cod_geo_zone_id\'];]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				}elseif(isset($store_info[\'payment_cod_geo_zone_id\'])){\r\n				 $data[\'payment_cod_geo_zone_id\'] = $store_info[\'payment_cod_geo_zone_id\'];\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'payment_cod_status\'] = $this->request->post[\'payment_cod_status\'];]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				}elseif(isset($store_info[\'payment_cod_status\'])){\r\n				 $data[\'payment_cod_status\'] = $store_info[\'payment_cod_status\'];\r\n			]]></add>\r\n		</operation>\r\n		<operation>\r\n			<search><![CDATA[$data[\'payment_cod_sort_order\'] = $this->request->post[\'payment_cod_sort_order\'];]]></search>\r\n			<add position=\"after\"><![CDATA[\r\n				}elseif(isset($store_info[\'payment_cod_sort_order\'])){\r\n				 $data[\'payment_cod_sort_order\'] = $store_info[\'payment_cod_sort_order\'];\r\n			]]></add>\r\n		</operation>\r\n	</file>\r\n	\r\n</modification>', 1, '2021-02-02 22:20:44');
...
('9b57cb841ae8c9e02ef20b6280', '{\"user_id\":\"1\",\"user_token\":\"CfYsyCBDZiCxDo3FecA5EeBlD2OjK1Wp\",\"install\":\"TqSBw2tlSM\",\"language\":\"en-gb\",\"currency\":\"USD\"}', '2021-02-02 21:24:40');
...
(42, 0, 'config', 'config_invoice_prefix', 'INV-2021-00', 0),
...
(201, 0, 'config', 'config_email', 'ernest.mikaelian123@gmail.com', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin_test', '202becdc3ffbfa4f322b684416e383fe187fa5e6', '5RoGdVGuh', 'John', 'Doe', 'ernest.mikaelian123@gmail.com', '', '', '127.0.0.1', 1, '2021-02-02 22:14:39');
